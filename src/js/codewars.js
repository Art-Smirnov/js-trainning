...
/**FizzBuzz is often one of the first programming puzzles people learn. Now undo it with 
 * reverse FizzBuzz!

Write a function that accepts a string, which will always be a valid section of FizzBuzz. 
Your function must return an array that contains the numbers in order to generate the given 
section of FizzBuzz.

Notes:

If the sequence can appear multiple times within FizzBuzz, return the numbers that generate
 the first instance of that sequence.
...
//   if (arr.indexOf('Fizz') === 0) {
//     arr[0] = String(arr[1] - 1);
//   }
//   arr[arr.indexOf('Fizz')] = String(Number(arr[arr.indexOf('Fizz') - 1]) + 1);
//   console.log(arr);
// }
